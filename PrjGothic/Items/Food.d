...
//	Npc_ChangeAttribute(self,ATR_HITPOINTS,HP_Bugmeat);
	...
	{
		PrintScreen("Ммм.. ямми",-1,-1,FONT_SCREENH,3);
		PrintScreen("Ауимбуве-Ауимбуве.. ауимбуве ауимбуве..",-1,52,FONT_SCREENH,5);
		PrintScreen("У у у у ууу ауу-имбуу-вее!",-1,54,FONT_SCREENH,5);
	};
};
...
//	text[1] = NAME_Bonus_HP;
//	count[1] = HP_Wasser;
	text[2] = "Ненадолго утоляет жажду и голод";
	text[5] = NAME_Value;
...
instance test_SatietyUp(C_Item)
{
	...
	description = name;
	text[1] = "Увеличивает сытость на 10";
	count[1] = 10;
};
...
instance test_SatietyDown(C_Item)
{
	...
	description = name;
	text[1] = "Уменьшает сытость на 10";
	count[1] = 10;
};
