...
instance ItFo_Potion_Elixier_Egg(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "«елье из €иц  оролевы ползунов";
	text[1] = NAME_Bonus_ManaMax;
	count[1] = ManaMax_ElixierEgg;
	text[3] = "Ќастраивает на св€зь со —п€щим.";
	text[5] = NAME_Value;
...
instance ItFo_Potion_Size_20(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "«елье изменени€ размера";
	text[1] = "¬ыпивший станет могуч как тролль.";
	text[3] = NAME_Duration;
	count[3] = Time_Haste3 / 60000;
	text[5] = NAME_Value;
	count[5] = value;
...
func void UseSizePotion20()
{
	...
	PrintDebugNpc(PD_ITEM_MOBSI,"„то с моим размером?");
};
...
instance ItFo_Potion_Size_10(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "«елье изменени€ размера";
	text[1] = "ћен€ет размер существа до нормального.";
	text[3] = NAME_Duration;
	count[3] = Time_Haste3 / 60000;
	text[5] = NAME_Value;
	count[5] = value;
...
instance ItFo_Potion_Size_05(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "«елье изменени€ размера";
	text[1] = "ћен€ет размер существа до размеров детеныша падальщика.";
	text[3] = NAME_Duration;
	count[3] = Time_Haste3 / 60000;
	text[5] = NAME_Value;
	count[5] = value;
...
instance ItFo_Potion_Size_01(C_Item)
{
	...
	scemeName = "POTIONFAST";
	description = "«елье изменени€ размера";
	text[1] = "ћен€ет размер существа до размеров м€сного жука.";
	text[3] = NAME_Duration;
	count[3] = Time_Haste3 / 60000;
	text[5] = NAME_Value;
	count[5] = value;
