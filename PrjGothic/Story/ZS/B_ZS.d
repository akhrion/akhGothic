...
func void B_ExitArmor()
{
	...
	myarmor = Npc_GetEquippedArmor(self);
	if(
		Hlp_IsItem(myarmor,grd_armor_l) ||
		Hlp_IsItem(myarmor,org_armor_l) ||
		Hlp_IsItem(myarmor,org_armor_m) ||
		Hlp_IsItem(myarmor,sld_armor_m)
	)
	{
		AI_PlayAni(self,"T_LGUARD_2_STAND");
	}
	else if(
		Hlp_IsItem(myarmor,grd_armor_h) ||
		Hlp_IsItem(myarmor,grd_armor_m) ||
		Hlp_IsItem(myarmor,org_armor_h) ||
		Hlp_IsItem(myarmor,sld_armor_h)
	)
	{
		AI_PlayAni(self,"T_HGUARD_2_STAND");
	};
