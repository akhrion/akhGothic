...
func void Startup_Sub_Surface()
{
	...
	Wld_InsertNpcAndRespawn(Molerat,"SPAWN_OW_MOLERAT_CAVE1_OC",10);
	Wld_InsertNpcAndRespawn(Molerat,"SPAWN_OW_MOLERAT_CAVE1_OC",10);
	...
	Wld_InsertNpc(Bloodfly,"SPAWN_BLOODFLYPATH_OC_PSI_14");
	Wld_InsertNpcAndRespawn(Meatbug,"SPAWN_OW_MEATBUG_01_01", 5);
	Wld_InsertNpcAndRespawn(Meatbug,"SPAWN_OW_MEATBUG_01_01", 5);
	Wld_InsertNpcAndRespawn(YMolerat,"SPAWN_MOLERAT02_SPAWN01", 5);
	Wld_InsertNpcAndRespawn(YScavenger,"SPAWN_SCAVENGER_TOTU_LEFT_PLAT", 5);
	Wld_InsertNpcAndRespawn(YScavenger,"SPAWN_SCAVENGER2_TOTU_LEFT_PLAT2", 5);
	Wld_InsertNpcAndRespawn(YMolerat,"SPAWN_MOLELRAT_TOTU_LEFT_PLAT4", 10);
...
func void init_player()
{
	...
	B_LogEntry(KDFLETTER,"Ïåðåä îòïðàâêîé çà Áàðüåð êàêîé-òî ñåäîé ìàã âûäàë ìíå ïèñüìî, êîòîðîå íåîáõîäèìî îòíåñòè ìàãàì Îãíÿ.");
