...
const string MOBNAME_BACKPACK_1 = "111";
...
const string MOBNAME_CAMP = "Костер";
const string MOBNAME_TORCH = "Факел";
const string MOBNAME_TORCHHOLDER = "Держатель факела";
const string MOBNAME_BARBQ_SCAV = "Барбекю";
const string MOBNAME_BARRELO_OC = "333";
const string MOBNAME_BENCH = "Сидалище сажай";
...
const string MOBNAME_LAB = "555";
const string MOBNAME_BOOK = "Аналой";
const string MOBNAME_CHAIR = "Табурет";
const string MOBNAME_CAULDRON = "Котел";
const string MOBNAME_THRONE = "Трон";
const string MOBNAME_PAN = "Сковорода";
const string MOBNAME_REPAIR = "Починить";
const string MOBNAME_WATERPIPE = "Кальян";
const string MOBNAME_LADDER = "Лестница";
const string MOBNAME_SWITCH = "Переключатель";
const string MOBNAME_BARONSTHRONE = "Трон";
const string MOBNAME_ORE = "Залежи руды";
const string MOBNAME_ROPEWAY = "999";
const string MOBNAME_STOMPER = "000";
const string MOBNAME_BELLOW = "Кузнечный мех";
const string MOBNAME_STONEMILL = "aaa";
const string MOBNAME_ORC_MUMMY = "Мумия";
const string MOBNAME_PILLAR = "Колонна";
const string MOBNAME_BASKET_RICE = "qwe";
const string MOBNAME_DRUM = "Барабаны";
const string MOBNAME_GROUND_SLOT = "zxc";
const string MOBNAME_HERB_PSI = "Ступа";
const string MOBNAME_HERBSTOMPER = "Ступа";
const string MOBNAME_IDOL = "Статуя";
const string MOBNAME_LEAN_WALL = "Облокотиться";
const string MOBNAME_ORCDRUM = "Орочьи барабаны";
...
const string MOBNAME_BARRELO = "Бочка";
const string MOBNAME_PAUKE = "Па'ук";//in extremo; ударение на "А";
...
const string TXT_SPELLS[MAX_SPELL] =
{
	...
	"Огненный дождь",
	"",
	"Телепортация к магам Огня",
	"Телепортация к магам Воды",
	"Телепортация к некроманту",
	"Орочье заклинание",
	"Телепортация в Болотный лагерь",
	...
	"Гнев",
	"Лечение ближнего",
	"2you can delete it or replace",
	"3you can delete it or replace",
	"4you can delete it or replace",
	"5you can delete it or replace",
	"5you can delete it or replace",
	"Лечение ближнего2you can delete it or replace"
};
...
const string TXT_TALENTS_SKILLS[12] =
{
	...
	"не обучен|обучен",
	"не обучен|обучен",
	"не обучен|ученик|ученик|подающий надежды ученик|талантливый ученик|опытный ученик|охотник|охотник|опытный охотник|мастер",//"не обучен|ученик|ученик|охотник|мастер шкуры на стреле",
	"не обучен|обучен"
};
...
const string NAME_SC_PARAM_SATIETY_V[6] =
{
	"Обожрался",
	"Хорошо",
	"Норма",
...
const string NAME_ConvoiWache = "Охранник конвоя";
const string NAME_Torwache = "Привратник";
const string NAME_Brueckenwache = "Стражник моста";
...
const string NAME_Raeuber = "Разбойник";
...
const string NAME_Prot_W = "Защита от кулаков\меча\стрел:       ";
const string NAME_Prot_M = "Защита от огня\ветра\магии\падения: ";
...
const int _TIME_MESSAGE_REDUCEATTRIBUTE = 3;
...
const string NAME_RaiseMana = "Магическая сила +";
const string NAME_RaiseManaMax = "Макс. магическая сила +";
const string NAME_RaiseHealth = "Жизненная сила +";
const string NAME_RaiseHealthMax = "Макс. жизненная сила +";
const string NAME_ReduceStrength = "Сила -";
const string NAME_ReduceDexterity = "Ловкость -";
const string NAME_ReduceStrDex = "Сила и ловкость -";
const string NAME_ReduceMana = "Магическая сила -";
const string NAME_ReduceManaMax = "Макс. магическая сила -";
const string NAME_REduceHealth = "Жизненная сила -";
const string NAME_REduceHealthMax = "Макс. жизненная сила -";
...
const string NAME_SC_PARAM_SATIETY = "Сытость: ";
const string TXT_Achieve_Jumper = "Попрыгунчик";
const string TXT_Achieve_Forsage = "Первая звуковая";
const string TXT_Achieve_Forsage2 = "Ебушки воробушки.. куда ты полетел, братик?";
const string TXT_Achieve_Savior = "'Избавитель от грехов'";
const string TXT_Achieve_Povarenok = "Поваренок";
