...
func void DIA_BaalParvez_RightWay_Info()
{
	...
	if(Npc_HasEquippedArmor(other))
	{
		...
		if(itm.disguiseGuild == GIL_NOV)
		{
			AI_Output(self,other,"DIA_BaalParvez_RightWay_NULL_051"); //Вижу ты уже бывал у нас и теперь ты, разумеется, стараешься нести просветление неуверовавшим. Хорошо. Но лучше вернись в наше братство.
			AI_Output(self,other,"DIA_BaalParvez_RightWay_NULL_052"); //Тебе еще многое нужно узнать.
		}
		else
		{
