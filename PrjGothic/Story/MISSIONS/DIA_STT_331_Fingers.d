...
func int XP_Fingerstrain_Func()
{
	var int xp;
	if(Npc_GetTalentSkill(other,NPC_TALENT_PICKLOCK) == 2){xp=XP_Fingerstrain*5;}
	else if(Npc_GetTalentSkill(other,NPC_TALENT_PICKLOCK) == 1){xp=XP_Fingerstrain*1;};
	if(Npc_GetTalentSkill(other,NPC_TALENT_PICKPOCKET) == 2){xp+=XP_Fingerstrain*5;}
	else if(Npc_GetTalentSkill(other,NPC_TALENT_PICKPOCKET) == 1){xp+=XP_Fingerstrain*1;};
	if(Npc_GetTalentSkill(other,NPC_TALENT_SNEAK)){xp+=XP_Fingerstrain*5;};
	return xp;
};
