...
const int NPC_BURN_TICKS_PER_DAMAGE_POINT = 10000;
const int NPC_BLEEDING_TIK_PER_SECS = 5;
const int NPC_BLEEDING_TIK_PER_GAME_MINS = 1;
const int NPC_BLEEDING_CHANCE_WOLF = 70;
...
const int SENSE_RANGE_SEE_HUMAN_Q = 3;
const int SENSE_RANGE_HEAR_HUMAN_Q = 1;
const int SENSE_RANGE_SMELL_HUMAN_Q = 3;
const int SENSE_RANGE_SEE_MONSTER_Q = 3;
const int SENSE_RANGE_HEAR_MONSTER_Q = 3;
const int SENSE_RANGE_SMELL_MONSTER_Q = 5;
...
const int PERC_ASSESSTHREAT = 10;		//bow aim
...
const int PERC_ASSESSWARN = 15;		//when flee from strong enemy
...
const string SPAWN_POINT_DEF = "WP_INTRO09";
const int MAX_SPELL = 61;
const int Time_Day = 1440;
const int Time_Hour = 60;
const int Time_Minute = 1;
const int HoneycombLover_ExpPeriod = Time_Day;
const string Overlay_Drunk = "HUMANS_DRUNKEN.MDS";
const string Overlay_Sprint = "HUMANS_SPRINT.MDS";
const int Achieve_Jumper_JumpAmount = 1000;
const int Achieve_Forsage_JumpAmount = 20;
const int Achieve_Forsage2_JumpAmount = 100;
const int Achieve_Savior_KillAmount = 2;
const int OneShot_Scavenger = 10;
const int OneShot_Molerat = 10;
const int OneShot_Bloodfly = 10;
const int OneShot_Wolf = 10;
const int OneShot_OrcDog = 10;
const int OneShot_Lurker = 10;
const int OneShot_Waran = 10;
const int OneShot_Snapper = 10;
const int OneShot_Razor = 10;
const int OneShot_MineCrawler = 10;
const int OneShot_Swampshark = 10;
const int OneShot_Shadowbeast = 10;
const int SC_Stamina_Max = 100;
const int Damage_StaminaMultiplicator = 250;
const int MinDamage_TwoHanded = 5;
