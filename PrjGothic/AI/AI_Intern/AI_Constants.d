...
const int AIV_DEAD_Timestamp = 26;
...
const int AIV_SpecStatesTiks = 45;
const int SST_BLEEDING = 1;
const int AIV_VisualType = 46;
const int AIV_Memory = 47;
const int AIV_M_Attentioned = 1;
const int AIV_M_Smelled = 2;
...
const int HAI_DIST_OBSERVEINTRUDER = 4000;
const int HAI_DIST_QUIETSOUND = 4000;
...
const int ID_SCAVENGER_YANG = 181;
...
const int ID_MOLERAT_YANG = 261;
const int ID_MOLERAT_BIG = 262;
...
const int ID_WARG = 36;
const int ID_ORCDOG = 37;
const int ID_LURKER_DAM = 38;
const int ID_FIREGOLEM_PART = 39;
const int ID_EGG = 40;
const int ID_REVIVE = 41;
const int ID_TEST_SKELETON = 42;
...
const int AIV_MM_bOneShot = 28;
const int AIV_MM_VisualType = 46;
const int VT_THIN = 1;
...
const int AIV_BOOLPOOL47 = 47; //Это пул для булевых переменных с префиксом BP47_
const int BP47_PAYDAY = 1; //Устанавливается в true, если НПС заплатил руду стражнику-ГГ; устанавливается каждый день в false в 00:00/////////НЕ РЕАЛИЗОВАНА ДО КОНЦА.. шот я всё
const int MID_CANYONTROLL = 5000;
const int MID_THEKEEPER = 5001;
const int MID_YOUNGTROLL = 5003;
const int Satiety_Deadly = 0;
const int Satiety_Starvation = 1;
const int Satiety_Hunger = 30;
const int Satiety_Normal = 70;
const int Satiety_Good = 100;
const int Satiety_Overeat = 120;
const int Satiety_Decreasing_Per_Time = 30;
const int Satiety_State_Deadly = Satiety_Deadly;
const int Satiety_State_Starvation = Satiety_Starvation;
const int Satiety_State_Hunger = Satiety_Hunger;
const int Satiety_State_Normal = Satiety_Normal;
const int Satiety_State_Good = Satiety_Good;
const int Satiety_State_Overeat = Satiety_Overeat;
const int Satiety_Mult_Overeat = 50;
const int Satiety_Mult_Good = 100;
const int Satiety_Mult_Normal = 100;
const int Satiety_Mult_Hunger = 130;
const int Satiety_Mult_Starvation = 20;
const int Satiety_Mult_Deadly = 1; //can't be zero.. you know..
