...
func void B_MM_ReactToDamage()
{
	...
	{
		PrintDebugNpc(PD_MST_FRAME,"...Monster ist JВger");
		Npc_SetTarget(self,other);
		Npc_ClearAIQueue(self);
		Npc_PercDisable(self,PERC_ASSESSENEMY);
		AI_StartState(self,ZS_MM_Attack,0,"");
...
func int ZS_MM_Attack_Loop()
{
	...
	if(Hlp_IsValidNpc(other) && !C_NpcIsDown(other))
	{
		...
		{
			PrintDebugNpc(PD_MST_LOOP,"...Ziel lВuft oder springt!");
	...
	{
		PrintDebugNpc(PD_ZS_Check,"...Ziel ist ungВltig oder kampf-unfВhig!");
