...
//	step_height[GIL_BLOODFLY] = 100;
	step_height[GIL_BLOODFLY] = 999999;
//	jumplow_height[GIL_BLOODFLY] = 800;
	jumplow_height[GIL_BLOODFLY] = 999999;
//	slide_angle[GIL_BLOODFLY] = 75;
	slide_angle[GIL_BLOODFLY] = 90;
	disable_autoroll[GIL_BLOODFLY] = 0;
	surface_align[GIL_BLOODFLY] = 0;
	turn_speed[GIL_BLOODFLY] = 230;
	falldown_height[GIL_BLOODFLY] = 999999;
	...
	dive_time[GIL_SKELETON] = TIME_INFINITE;
	water_depth_knee[GIL_SKELETON] = 150;
	water_depth_chest[GIL_SKELETON] = 9999;
	...
	fight_range_base[GIL_SKELETON] = 10;
	...
	dive_time[GIL_ZOMBIE] = TIME_INFINITE;
	water_depth_knee[GIL_ZOMBIE] = 120;
	water_depth_chest[GIL_ZOMBIE] = 9999;
